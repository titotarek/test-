...
export default {
	...
	methods: {
		...
		// 		const parsedPhoneNumber = phoneUtil.parse(phoneNumber, "GB");
		...
		submitForm() {
			...
			if (allFieldsValid) {
				...
				if (
					...
					this.validationErrors.FirstName = "FirstName has been taken.";
					allFieldsValid = false;
				}
				...
				if (
					...
					this.validationErrors.LastName = "LastName has been taken.";
					allFieldsValid = false;
				}
				...
				if (
					...
					this.validationErrors.DateOfBirth = "Date of Birth has been taken.";
					allFieldsValid = false;
				}
